...
const Header = () => {
  ...
  const fintechServices = [
    {
      name: "Pay-in & Pay-out Gateway",
      href: "/fintech/payment-gateway",
      icon: Wallet,
    },
    {
      name: "Business Software & APIs",
      href: "/fintech/business-software",
      icon: Building,
    },
    {
    ...
    {
      name: "Utility Payment Collection",
      href: "/fintech/utility-payments",
      icon: Receipt,
    },
    ...
    {
      name: "White-label B2B Software",
      href: "/fintech/white-label",
      icon: Users,
    },
  ];
