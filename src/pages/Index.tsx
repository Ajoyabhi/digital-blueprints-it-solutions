  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden hero-gradient">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-navy-900/50 via-transparent to-navy-900/50"></div>
        ...
        {/* Floating Elements */}
        <div className="absolute top-20 left-10 w-20 h-20 bg-electric-500/20 rounded-full animate-float"></div>
        <div className="absolute bottom-20 right-10 w-16 h-16 bg-neon-500/20 rounded-full animate-float" style={{animationDelay: '1s'}}></div>
